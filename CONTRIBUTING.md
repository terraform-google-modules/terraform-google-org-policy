...
To use this setup, you need a service account with these permissions:
- Project Creator (on a Folder or Organization level)
- Project Billing Manager (on a Folder or Organization level)
- IAM Security Admin (Organization level)
