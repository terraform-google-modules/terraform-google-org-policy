...
resource "google_organization_policy" "org_policy_list_allow_all" {
  count = !var.use_google_org_policy_policy && local.organization && local.list_policy && local.enforce == false ? 1 : 0
...
resource "google_folder_organization_policy" "folder_policy_list_allow_all" {
  count = !var.use_google_org_policy_policy && local.folder && local.list_policy && local.enforce == false ? 1 : 0
...
resource "google_project_organization_policy" "project_policy_list_allow_all" {
  count = !var.use_google_org_policy_policy && local.project && local.list_policy && local.enforce == false ? 1 : 0
...
resource "google_organization_policy" "org_policy_list_deny_all" {
  count = !var.use_google_org_policy_policy && local.organization && local.list_policy && local.enforce == true ? 1 : 0
...
resource "google_folder_organization_policy" "folder_policy_list_deny_all" {
  count = !var.use_google_org_policy_policy && local.folder && local.list_policy && local.enforce == true ? 1 : 0
...
resource "google_project_organization_policy" "project_policy_list_deny_all" {
  count = !var.use_google_org_policy_policy && local.project && local.list_policy && local.enforce == true ? 1 : 0
...
resource "google_organization_policy" "org_policy_list_deny_values" {
  count = !var.use_google_org_policy_policy && local.organization && local.list_policy && var.deny_list_length > 0 ? 1 : 0
...
resource "google_folder_organization_policy" "folder_policy_list_deny_values" {
  count = !var.use_google_org_policy_policy && local.folder && local.list_policy && var.deny_list_length > 0 ? 1 : 0
...
resource "google_project_organization_policy" "project_policy_list_deny_values" {
  count = !var.use_google_org_policy_policy && local.project && local.list_policy && var.deny_list_length > 0 ? 1 : 0
...
resource "google_organization_policy" "org_policy_list_allow_values" {
  count = !var.use_google_org_policy_policy && local.organization && local.list_policy && var.allow_list_length > 0 ? 1 : 0
...
resource "google_folder_organization_policy" "folder_policy_list_allow_values" {
  count = !var.use_google_org_policy_policy && local.folder && local.list_policy && var.allow_list_length > 0 ? 1 : 0
...
resource "google_project_organization_policy" "project_policy_list_allow_values" {
  count = !var.use_google_org_policy_policy && local.project && local.list_policy && var.allow_list_length > 0 ? 1 : 0
